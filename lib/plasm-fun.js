 ...
 */
 ...
 !(function (exports) {
  ...
  var NORMALIZEDCOLOR =
  fun.NORMALIZEDCOLOR = function (rgb) {
    return function (object) {
  ...
  fun.COLOR = function (rgb) {
    return function (object) {
      var innerNormalize = function(rgbArray) {
       return [(rgbArray[0] || 0) / 255), (rgbArray[1] || 0) / 255), (rgbArray[2] || 0) / 255)];
      };
      
      return object.color(innerNormalize(rgb));
    };
  };  
