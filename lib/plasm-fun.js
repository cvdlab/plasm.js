 ...
 */
 ...
 !(function (exports) {
  ...
  fun.TORUSSOLID = function (dims) {
    return function (subs) {
      return plasm.torusSurface(dims[0], dims[1], subs[0], subs[1], subs[2]);
    };
  };
  ...
  fun.TRIANGLESTRIP = function (points) {
    return plasm.triangleStrip(points);
  };
  ...
  fun.TRIANGLEFAN = function (points) {
    return plasm.triangleFan(points);
  };
  ...
  fun.HELIX = function (r, pitch, n, turns) {
    return plasm.helix(r, pitch, n, turns);
  };
