(function() {
  ...
  Topology = (function() {
    ...
    cell_complex = function(d_cells) {
      var cells, dim, h, _ref;
      if (d_cells.length > 0) {
        dim = (_ref = d_cells[0].length - 1) != null ? _ref : 0;
        if (dim !== -1) {
          cells = new Array(dim);
          cells[dim] = d_cells;
  ...
  SimplicialComplex = (function() {
    ...
    SimplicialComplex.prototype.boundary = function() {
      var boundary_pairs, boundary_signs, d, d1_faces, d_faces, dictos, facet, facets, father, hom, incidence, k, pair, vertices, _i, _len, _len2, _ref;
      d = this.faces.dim;
      ...
      boundary_signs = orientation(this)(d, d_faces);
      ...
      console.log("d1_faces =", numeric.prettyPrint(d1_faces));
      return new SimplicialComplex(vertices, d1_faces);
    };
