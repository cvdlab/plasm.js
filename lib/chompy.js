(function() {
  var E, PI, PRECISION, PointSet, SimplicialComplex, Topology, aa, abs, acos, al, apply, ar, asin, atan, atan2, bigger, biggest, butlast, cat, ceil, cell_complex, centroid, clone, code, comp, comp2, cons, coords_distribute, cos, decode, distl, distr, div, exp, explode, facets, fcode, fixedPrecision, floor, free, homology_maps, id, insl, insr, isNumber, k, len, list, log, mapcomp, mat, mkCellDB, model, mul, myprint, obj, outline, progressive_sum, remove_duplicates, repeat, replica, reverse, revert, rotate, round, s, shift, simplexGrid, sin, skeleton, smaller, smallest, sqrt, string2numberList, sub, subcomplex, sum, t, tail, tan, trans, type, typedPrint, uncode, vect;
