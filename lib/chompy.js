(function() {
  var E, PI, PRECISION, PointSet, SimplicialComplex, Topology, aa, abs, acos, al, apply, ar, asin, atan, atan2, bigger, biggest, butlast, cat, ceil, cell_complex, centroid, clone, code, comp, comp2, cons, coords_distribute, cos, decode, distl, distr, div, exp, explode, facets, fcode, fixedPrecision, floor, free, freeobj, homology_maps, id, insl, insr, isNumber, k, len, list, log, mapcomp, mat, mkCellDB, models, mul, myprint, obj, progressive_sum, remove_duplicates, repeat, replica, reverse, revert, rotate, round, s, shift, simplex, simplexGrid, sin, skeleton, smaller, smallest, sqrt, string2numberList, sub, subcomplex, sum, t, tail, tan, trans, type, typedPrint, uncode, vect;
  ...
  */
  ...
  skeleton = (dim) -> (pol) ->
    pol = clone pol
    console.log pol
    #out = SimplicialComplex(pol.vertices.verts, pol.faces.cells[dim])

  obj1 = skeleton(1)(obj)
  console.log "obj1",obj1

  #object2 = viewer.draw(skeleton(1)(obj))
  */
  ...
  models = (function() {
    var _i, _len, _results;
    _results = [];
    for (_i = 0, _len = freeobj.length; _i < _len; _i++) {
      simplex = freeobj[_i];
      _results.push(viewer.draw(simplex));
    }
    return _results;
  })();
