...
/*!
 * plasm.js
 * about JavaScript Programming Language for Solid Modeling
 * copyright 2011 cvd-lab <cvdlab@email.com> (https://github.com/cvd-lab/)
 * license MIT
 */
 ...
 !(function (exports) {
  ...
  plasm.Viewer.prototype.simplex = function (d) {
    var complex = new simplexn.simplex(d);
    var model = new plasm.Model(complex, this);
    return model;
  };
  ...
  plasm.Viewer.prototype.polyline = function (points) {
    var complex = new simplexn.polyline(points);
    var model = new plasm.Model(complex, this);
    return model;
  };
  ...
  plasm.Viewer.prototype.disk = function (radius, n, m) {
    var complex = new simplexn.geometries.circle(radius, n, m);
    var model = new plasm.Model(complex, this);
    return model;
  };
  ...
  plasm.Viewer.prototype.cylinderSurface = function (r, h, n, m) {
    var complex = new simplexn.geometries.circle(r, h, n, m);
    var model = new plasm.Model(complex, this);
    return model;
  };
  ...
  plasm.Viewer.prototype.torusSurface = function (r_min, r_max, n, m) {
    var complex = new simplexn.geometries.circle(r_min, r_max, n, m);
    var model = new plasm.Model(complex, this);
    return model;
  };
  ...
  simplexn.geometries.torusSolid = function (r_min, r_max, n, m, p) {
    var complex = new simplexn.geometries.circle(r_min, r_max, n, m, p);
    var model = new plasm.Model(complex, this);
    return model;
  };
