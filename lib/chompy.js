(function() {
  var AA, AL, APPLY, AR, BIGGER, BIGGEST, BOUNDARY, BUTLAST, CAT, CENTROID, COMP, CONS, DISTL, DISTR, DIV, E, EXPLODE, EXTRUDE, FREE, ID, INSL, INSR, ISFUN, ISNUM, K, LEN, LIST, MAT, MUL, MYPRINT, PI, PRECISION, PROGRESSIVE_SUM, PointSet, REPEAT, REPLICA, REVERSE, S, SIMPLEXGRID, SKELETON, SMALLER, SMALLEST, SUB, SUM, SimplicialComplex, T, TAIL, TRANS, Topology, VECT, abs, acos, asin, atan, atan2, ceil, clone, code, cos, decode, exp, fcode, fixedPrecision, floor, log, root, round, sin, sqrt, string2numberList, tan, type, typedPrint, uncode;
