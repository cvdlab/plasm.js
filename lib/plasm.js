 ...
 */
 ...
 !(function (exports) {
  ...
  plasm.Model.prototype.clone = function () {
    return this.node ? this : new plasm.Model(this.complex.clone(), this.viewer);
  };
  ...
  plasm.Model.prototype.draw = function () {
    ...
    THREE.SceneUtils.traverseHierarchy(this.mesh, function (obj) {
      if (obj instanceof THREE.Object3D 
          && obj.geometry 
          && obj.geometry.vertices.length) {
  ...
  plasm.Model.prototype.color = function (rgb) {
     THREE.SceneUtils.traverseHierarchy(this.mesh, function (obj) {
      if (obj instanceof THREE.Object3D 
        ...
        obj.material.color.setRGB(rgb[0] || 0, rgb[1] || 0, rgb[2] || 0);
      }
    });

    this.mesh.material && this.mesh.material.color.setRGB(rgb[0] || 0, rgb[1] || 0, rgb[2] || 0);
  ...
  plasm.Viewer.prototype.struct = function (items) {
    var struct = new plasm.Model(null, p);
    var m1 = struct;
    var m2;
  ...
  plasm.Viewer.prototype.axes = function () {
    ...
    var axes = new plasm.Model(null, this);
